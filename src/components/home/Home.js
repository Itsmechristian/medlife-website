  ...
  render() {
    return (
      <div className="home">
        <Bgpreload
          className="header"
          preloadimage={dentistchairmin}
          hdimage={dentistchair}
        >
          ...
          <div className="container">
            <div className="section-one">
              <div className="header">
                <section>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Repellendus quia quaerat nobis aliquam nihil distinctio
            ...
            <div className="section-three">
              <div className="left-side">
                <Imgpreload smallimage={doctorteamsmall} hdimage={doctorteam} />
              </div>
              <div className="right-side">
                ...
                <p>
                  ...
                  fuga mollitia laborum facilis veniam sint harum tempora
                  veritatis est repellendus unde deleniti eveniet, aperiam
                  soluta rerum officia, ipsa illo expedita neque officiis? Quod
                  nam mollitia neque? Optio perspiciatis, illo incidunt
                  asperiores, id fugiat in, adipisci quidem recusandae quas fuga
                  non!
                </p>
                <Link to="/services">
                  <div className="link">
